...
class EELogShowController(CementBaseController):
    class Meta:
        ...
        arguments = [
            ...
            (['--fpm'],
                dict(help='Show PHP7.0-fpm slow logs file',
                     action='store_true')),
            (['--mysql'],
...
class EELogResetController(CementBaseController):
    class Meta:
        ...
        arguments = [
            ...
            (['--fpm'],
                dict(help='Reset PHP7.0-fpm slow logs file',
                     action='store_true')),
            (['--mysql'],
...
class EELogGzipController(CementBaseController):
    class Meta:
        ...
        arguments = [
            ...
            (['--fpm'],
                dict(help='GZip PHP7.0-fpm slow logs file',
                     action='store_true')),
            (['--mysql'],
...
class EELogMailController(CementBaseController):
    class Meta:
        ...
        arguments = [
            ...
            (['--fpm'],
                dict(help='Mail PHP7.0-fpm slow logs file',
                     action='store_true')),
            (['--mysql'],
