 ...
 */
define( 'EE_DEBUG_LOG_FILE', EE_ROOT . '/testlog.log' );
define( 'EE_WP_CLI', '0.24.1' );
define( 'EE_NGINX_SITE_AVAIL_DIR', '/etc/nginx/sites-available/' );
...
define('EE_ROUNDCUBE', '1.1.4');
define('EE_VIMBADMIN', 'master');
